---
toolName: "cad-drawing-number-batch-renumber"
description: ""
version: "1.0.0"
author: "김동건축"
sectionId: "servers"
...
- DWG 파일 목록: 여러 DWG를 직접 선택하고 추가/삭제/정렬합니다.
- 도곽 선택 방식: 첫 DWG에서 도곽 후보 블록 리스트 표시 또는 직접 선택.
- 기준 검색 문자: `P-`처럼 도면번호 위치를 찾을 일부 문자.
- 검색 대상 문자: Text, MText.
- 도곽 순서: 좌상단에서 우하단.
- 새 도면번호 규칙: 접두어, 시작번호, 자리수, 증가값.
- 실행 옵션: 미리보기만 실행, 백업 정책, 최종 확인.
...
| DWG 파일 | 도곽 | 기존 도면번호 | 새 도면번호 | 상태 |
|---|---:|---|---|---|
| A-101_평면도.dwg | 1 | P-001 | P-101 | 성공 |
| A-101_평면도.dwg | 2 | P-002 | P-102 | 성공 |
| A-102_평면도.dwg | 1 | P-003 | P-103 | 성공 |
